 ...
 * source directory to static HTML, with full multi-locale support, content
 ...
 *   ssg/markdown.ts          - .md locale resolution + title extraction
 ...
 *
 * Output structure (using localized route names, full BCP 47 locale in the
 * URL, in canonical lowercase form - see config/supported_locales.ts):
 *   /dist/
 *     index.html              ← default locale (sl-si) at root
 *     /o-nas/index.html       ← sl-si localized /about → "o-nas"
 *     /en-us/                 ← other locales under their lowercase /{locale} prefix
 *       index.html
 *       /about/index.html
 *
 * Locale-variant templates (about.sl-si.ree → about.en-us.ree → about.ree,
 * lowercase) are resolved automatically by the template engine.
 */
