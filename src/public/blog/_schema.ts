 ...
 *
 * Validated per physical `.md` file, including locale variants
 * (`post.sl-si.md`, `post.en-us.md`). The route's own listing index (`blog/index.md`)
...
export const schema = z.object(
	{
		...
		published_at: required_date("published_at"), // accepts a Date or "YYYY-MM-DD"
		last_updated_at: optional_date("last_updated_at"), // friendly alias for sitemap <lastmod>
